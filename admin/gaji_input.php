          ...
          <table align="center">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <table>
                        <tr>
                            <td><i class="fa fa-edit"></i> Input Gaji Guru</td>
                            <td>&nbsp;&nbsp;-&nbsp;&nbsp;</td>
                            <td>
                                <div class="Tanggal">
            ...
            <div class="alert alert-success alert-dismissable">
              ...
              Anda Berada di Halaman Input Gaji Guru...!!!
            </div>
          </div>
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-edit"></i> Input Gaji Guru</h3>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                  <?php
                  $query = mysqli_query($koneksi,"SELECT ID_GURU, NAMA_GURU FROM guru WHERE ID_GURU='$_GET[kd]'");
                  $data  = mysqli_fetch_array($query);
                  ?>
                  <form action="gaji_insert.php" method="post" autocomplete="off" name="transfer">
                    <table class="table table-condensed">
                      ...
                      <tr>
                        ...
                        <td><input name="GAJI_PERJAM" type="number" class="form-control" id="GAJI_PERJAM"
                        value="<?php 
                        $query_gaji_p= mysqli_query ($koneksi, "SELECT GAJI_P
                        FROM guru 
                        WHERE ID_GURU ='$data[ID_GURU]'");
                        $gaji_p = mysqli_fetch_array($query_gaji_p);
                        echo $gaji_p['GAJI_P'];?>" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()" onkeypress="hitung_gaji()" readonly="readonly"/></td>
                      </tr>
                      <tr>
                        <td><label for="TOTAL_JAM">Total Jam</label></td>
                        <td><input name="TOTAL_JAM" type="number" class="form-control" id="TOTAL_JAM" placeholder="Total Jam" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()" onkeypress="hitung_gaji()" required/></td>
                      </tr>
                      <tr>
                        <td><label for="TOTAL_TUNJANGAN">Total Tunjangan</label></td>
                        <td><input name="TOTAL_TUNJANGAN" type="number" class="form-control" id="TOTAL_TUNJANGAN" 
                        value="<?php 
                      ...
                      <tr>
                        ...
                        <td><input name="CICILAN" type="number" class="form-control" id="CICILAN" placeholder="Cicilan" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()" onkeypress="hitung_gaji()" required/></td>
                      </tr>
                      <tr>
                        <td><label for="BAKSOS">Baksos</label></td>
                        <td><input name="BAKSOS" type="number" class="form-control" id="BAKSOS" placeholder="Baksos" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()" onkeypress="hitung_gaji()" required/></td>
                      </tr>
                      <tr>
                        <td><label for="ARISAN">Arisan</label></td>
                        <td><input name="ARISAN" type="number" class="form-control" id="ARISAN" placeholder="Arisan" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()" onkeypress="hitung_gaji()" required/></td>
                      </tr>
                      <tr>
                        <td><label for="TOTAL_GAJI">Total Gaji</label></td>
                        <td><input name="TOTAL_GAJI" type="number" class="form-control" id="TOTAL_GAJI" value="0" readonly="readonly"/></td>
                      </tr> 
                      <tr>
                        <td><label for="TANGGAL">Tanggal</label></td>
                        <td><input name="TANGGAL" type="date" class="form-control" id="TANGGAL" required/></td>
                      </tr>
                      <tr>
