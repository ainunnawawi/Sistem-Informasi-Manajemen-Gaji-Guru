        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active"><a href="index.php"><i class="fa fa-user"></i> Data Guru</a></li>
                    <!--<li><a href="gaji_tampil.php"><i class="fa fa-table"></i> Data Gaji guru</a></li>-->
                    <li><a href="jabatan_tampil.php"><i class="fa fa-sitemap"></i> Tunjangan Jabatan</a></li>
                    <li><a href="tunjangan_tampil.php"><i class="fa fa-bar-chart-o"></i> Tunjangan Jabatan Guru</a></li>
                    <li><a href="gaji_tampil.php"><i class="fa fa-print"></i> Data Gaji Guru</a></li>
                    <li><a href="user_tampil.php"><i class="fa fa-desktop"></i> Data User</a></li>
