          ...
          <table align="center">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <table>
                        <tr>
                            <td><i class="fa fa-edit"></i> Edit Tunjangan Jabatan</td>
                            <td>&nbsp;&nbsp;-&nbsp;&nbsp;</td>
                            <td>
                                <div class="Tanggal">
            ...
            <div class="alert alert-success alert-dismissable">
              ...
              Anda Berada di Halaman Edit Tunjangan Jabatan...!!!
              </div>
          </div><!-- /.row -->
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-edit"></i> Edit Tunjangan Jabatan </h3>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                  <?php
                  $query = mysqli_query($koneksi, "SELECT * FROM jabatan WHERE ID_JABATAN='$_GET[kd]'");
                  $data  = mysqli_fetch_array($query);
                  ?>
                  <form action="jabatan_update.php" method="post">
                    <table class="table table-condensed">
                      <input name="ID_JABATAN" type="hidden" class="form-control" id="ID_JABATAN" value="<?php echo $data['ID_JABATAN']?>" readonly="readonly"/>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><input name="TUNJANGAN" type="text" class="form-control" id="TUNJANGAN" value="<?php echo $data['TUNJANGAN']?>" required/></td>
                      </tr>
                      <tr>
