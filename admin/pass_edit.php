          ...
          <table align="center">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <table>
                        <tr>
                            <td><i class="fa fa-edit"></i> Edit Password</td>
                            <td>&nbsp;&nbsp;-&nbsp;&nbsp;</td>
                            <td>
                                <div class="Tanggal">
            ...
            <div class="alert alert-success alert-dismissable">
              ...
              Anda Berada di Halaman Edit Password...!!!
              </div>
          </div><!-- /.row -->
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-edit"></i> Edit Password </h3>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                  <?php
                  $query = mysqli_query($koneksi, "select ID_USER, NAMA_GURU from guru NATURAL JOIN user WHERE ID_USER='$_GET[kd]'");
                  ...
                  <form action="pass_update.php" method="post">
                    <table class="table table-condensed">
                      ...
                      <tr>
                        <td><label for="PASS">Password Baru</label></td>
                        <td><input name="PASS" type="password" class="form-control" id="PASS" placeholder="Password Baru" required/></td>
                      </tr>
                      <tr>
                        <td><label for="PASS1">Konfirmasi Password</label></td>
                        <td><input name="PASS1" type="password" class="form-control" id="PASS1" placeholder="Konfirmasi Password" required/></td>
                      </tr>
                      <tr>
